...
class I2FPDataset(Dataset):
    ...
    def __init__(self, img_path, fp_path, rfimage, mean_std):
        ...
        self.force_label['Fx(N)'] = (self.force_label['Fx(N)'] - (-0.75)) / 1.5
        self.force_label['Fy(N)'] = (self.force_label['Fy(N)'] - (-0.75)) / 1.5
        self.force_label['Fz(N)'] = (self.force_label['Fz(N)'] - (-3)) / 3
